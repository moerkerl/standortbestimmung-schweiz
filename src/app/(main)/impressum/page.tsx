...
export const metadata: Metadata = {
  title: 'Impressum | Nachhilfeportal Zürich',
  description: 'Impressum des Nachhilfeportals Zürich - Kontaktinformationen und rechtliche Hinweise.',
}
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          <section className="mb-8">
            ...
            <p className="mb-4">
              <strong>Nachhilfeportal Zürich</strong><br />
