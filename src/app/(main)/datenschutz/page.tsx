...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung | Nachhilfeportal Zürich',
  description: 'Datenschutzerklärung des Nachhilfeportals Zürich - Erfahren Sie, wie wir Ihre Daten schützen und verarbeiten.',
}
