      ...
      <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className={`lg:w-[48%] ${index % 2 === 0 ? 'lg:ml-auto lg:pl-4' : 'lg:mr-auto lg:pr-4'}`}>
                <div className="step-content bg-white rounded-2xl shadow-xl p-8 relative">
                  ...
                  <div className={`step-icon absolute -top-5 w-12 h-12 bg-[#ff6b35] text-white rounded-full flex items-center justify-center ${
                    index % 2 === 0 
                      ? '-left-5' // Box is on right side -> icon on left (both mobile and desktop)
                      : '-left-5 lg:left-auto lg:-right-5' // Box is on left side -> icon on right (desktop only), left on mobile
                  }`}>
        ...
        <div className="process-cta text-center mt-16">
          <button 
            ...
            className="main-cta inline-flex items-center gap-3 bg-gradient-to-r from-[#ff6b35] to-[#e55a2b] text-white px-8 py-4 rounded-full hover:shadow-lg hover:transform hover:-translate-y-1 transition-all font-semibold text-lg cursor-pointer"
          >
